# Feathers UI Magic 8 Ball Chat Sample

This example app demonstrates how to create a chat view using [Feathers UI](https://feathersui.com/).

## Live demo

A build of the [_magic-8-ball-chat_ sample](https://feathersui.com/samples/haxe-openfl/magic-8-ball-chat/) is hosted on the Feathers UI website, and it may be viewed in any modern web browser.
