# Feathers UI: Tab Navigator

This example app demonstrates how use the [`TabNavigator`](https://feathersui.com/learn/haxe-openfl/tab-navigator) component from [Feathers UI](https://feathersui.com/).

## Live demo

A build of the [_tab-navigator_ sample](https://feathersui.com/samples/haxe-openfl/tab-navigator/) is hosted on the Feathers UI website, and it may be viewed in any modern web browser.
