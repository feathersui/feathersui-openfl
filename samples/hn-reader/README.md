# Feathers UI HN Reader

This example app demonstrates how to create a Hacker News Reader, similar to [HNPWA](https://hnpwa.com), using [Feathers UI](https://feathersui.com/).

## Live demo

A build of the [_hn-reader_ sample](https://feathersui.com/samples/haxe-openfl/hn-reader/) is hosted on the Feathers UI website, and it may be viewed in any modern web browser.
