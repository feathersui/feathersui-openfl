# Feathers UI Calculator

This example app demonstrates how to create a simple calculator using [Feathers UI](https://feathersui.com/).

## Live demo

A build of the [_calculator_ sample](https://feathersui.com/samples/haxe-openfl/calculator/) is hosted on the Feathers UI website, and it may be viewed in any modern web browser.
