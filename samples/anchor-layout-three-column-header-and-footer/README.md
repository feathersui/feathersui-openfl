# Feathers UI Three Column Layout with Header and Footer

This example app demonstrates how to create a three column layout with a header and footer using [`AnchorLayout`](https://feathersui.com/learn/haxe-openfl/anchor-layout/) from [Feathers UI](https://feathersui.com/). On the web, this type of layout is sometimes called the _One True Layout_.

## Live demo

A build of the [_anchor-layout-three-column-header-and-footer_ sample](https://feathersui.com/samples/haxe-openfl/anchor-layout-three-column-header-and-footer/) is hosted on the Feathers UI website, and it may be viewed in any modern web browser.
