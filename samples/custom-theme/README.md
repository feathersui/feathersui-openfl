# Feathers UI Custom Theme

This example app demonstrates how to create a custom theme for [Feathers UI](https://feathersui.com/).

## Live demo

A build of the [_custom-theme_ sample](https://feathersui.com/samples/haxe-openfl/custom-theme/) is hosted on the Feathers UI website, and it may be viewed in any modern web browser.
