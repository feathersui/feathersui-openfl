...
class MainMenu extends Panel {
	...
	override private function initialize():Void {
		...
		this.listView.dataProvider = new ArrayCollection([
			...
			new MenuItem("List View", ViewPaths.LIST_VIEW), new MenuItem("Panel", ViewPaths.PANEL),
			...
			new MenuItem("Tab Bar", ViewPaths.TAB_BAR), new MenuItem("Text Input", ViewPaths.TEXT_INPUT),
