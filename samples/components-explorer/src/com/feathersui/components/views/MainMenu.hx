...
class MainMenu extends Panel {
	...
	override private function initialize():Void {
		...
		this.listView.dataProvider = new ArrayCollection([
			...
			new MenuItem("Page Navigator", ViewPaths.PAGE_NAVIGATOR), new MenuItem("Panel", ViewPaths.PANEL),
			...
			new MenuItem("Tab Bar", ViewPaths.TAB_BAR), new MenuItem("Tab Navigator", ViewPaths.TAB_NAVIGATOR),
