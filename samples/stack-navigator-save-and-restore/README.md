# Feathers UI: Stack Navigator - Save and restore a view's history data

This example app demonstrates how a [`StackNavigator`](https://feathersui.com/learn/haxe-openfl/stack-navigator) can save a view's data in the history before navigating away, and restore it again later when returning back to the same position in the history.

## Live demo

A build of the [_stack-navigator-save-and-restore_ sample](https://feathersui.com/samples/haxe-openfl/stack-navigator-save-and-restore/) is hosted on the Feathers UI website, and it may be viewed in any modern web browser.
