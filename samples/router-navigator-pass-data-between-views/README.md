# Feathers UI: Router Navigator - Pass Data Between Views

This example app demonstrates how to pass data between views in a [`RouterNavigator`](https://feathersui.com/learn/haxe-openfl/router-navigator).

## Live demo

A build of the [_router-navigator-pass-data-between-views_ sample](https://feathersui.com/samples/haxe-openfl/router-navigator-pass-data-between-views/) is hosted on the Feathers UI website, and it may be viewed in any modern web browser.
