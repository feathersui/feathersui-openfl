# Feathers UI Custom Programmatic Skin with States

This example app demonstrates how to create a custom programmatic skin for a [Feathers UI](https://feathersui.com/) `Button` component. Many UI components have multiple states, including `Button`, `ToggleButton`, `TextArea`, and `TextInput`.

## Live demo

A build of the [_custom-programmatic-skin-with-states_ sample](https://feathersui.com/samples/haxe-openfl/custom-programmatic-skin-with-states/) is hosted on the Feathers UI website, and it may be viewed in any modern web browser.
