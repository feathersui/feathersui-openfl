# Feathers UI Numeric Stepper Button Layouts

This example app demonstrates the different ways that the buttons in a numeric stepper can be positioned by [Feathers UI](https://feathersui.com/).

## Live demo

A build of the [_numeric-stepper-button-layout_ sample](https://feathersui.com/samples/haxe-openfl/numeric-stepper-button-layout/) is hosted on the Feathers UI website, and it may be viewed in any modern web browser.
