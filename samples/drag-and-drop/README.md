# Feathers UI Drag And Drop Mode

This example app demonstrates how to use the `DragDropManager` from [Feathers UI](https://feathersui.com/).

## Live demo

A build of the [_drag-and-drop_ sample](https://feathersui.com/samples/haxe-openfl/drag-and-drop/) is hosted on the Feathers UI website, and it may be viewed in any modern web browser.
