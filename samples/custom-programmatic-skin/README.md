# Feathers UI Custom Programmatic Skin

This example app demonstrates how to create a custom programmatic skin for a [Feathers UI](https://feathersui.com/) component.

## Live demo

A build of the [_custom-programmatic-skin_ sample](https://feathersui.com/samples/haxe-openfl/custom-programmatic-skin/) is hosted on the Feathers UI website, and it may be viewed in any modern web browser.
