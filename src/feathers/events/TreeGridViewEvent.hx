...
class TreeGridViewEvent<S> extends Event {
	...
	**/
	...
	/**
		The `TreeGridViewEvent.CELL_DOUBLE_CLICK` event type is dispatched when a
		cell renderer is double-clicked with a mouse.

		@since 1.4.0
	**/
	public static inline var CELL_DOUBLE_CLICK:EventType<TreeGridViewEvent<TreeGridViewCellState>> = "cellDoubleClick";
