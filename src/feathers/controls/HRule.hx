...
/**
	...
	@since 1.4.0
**/
class HRule extends FeathersControl {
	/**
		Creates a new `HRule` object.

		@since 1.4.0
	**/
	public function new() {
		initializeHRuleTheme();
		super();
	}
	...
	/**
		...
		@see `HRule.disabledBackgroundSkin`
	...
	**/
	...
	private function initializeHRuleTheme():Void {
		#if !feathersui_disable_default_theme
		feathers.themes.steel.components.SteelHRuleStyles.initialize();
		#end
	}
