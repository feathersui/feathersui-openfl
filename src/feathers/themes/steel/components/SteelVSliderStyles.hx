...
class SteelVSliderStyles {
	public static function initialize(?theme:BaseSteelTheme):Void {
		...
		if (theme.styleProvider.getStyleFunction(VSlider, null) == null) {
			theme.styleProvider.setStyleFunction(VSlider, null, setStyles);
		}
	}

	private static function setStyles(slider:VSlider):Void {
