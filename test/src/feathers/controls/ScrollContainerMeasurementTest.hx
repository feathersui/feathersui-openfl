...
@:keep
class ScrollContainerMeasurementTest extends Test {
	...
	private function addPadding():Void {
		this._container.paddingTop = PADDING_TOP;
		this._container.paddingRight = PADDING_RIGHT;
		this._container.paddingBottom = PADDING_BOTTOM;
		this._container.paddingLeft = PADDING_LEFT;
	}
	...
	public function testAutoSizeWithPaddingAndNoChildren():Void {
		this.addPadding();
		this._container.validateNow();
		Assert.equals(PADDING_LEFT + PADDING_RIGHT, this._container.width);
		Assert.equals(PADDING_TOP + PADDING_BOTTOM, this._container.height);
		Assert.equals(PADDING_LEFT + PADDING_RIGHT, this._container.minWidth);
		Assert.equals(PADDING_TOP + PADDING_BOTTOM, this._container.minHeight);
		Assert.equals(Math.POSITIVE_INFINITY, this._container.maxWidth);
		Assert.equals(Math.POSITIVE_INFINITY, this._container.maxHeight);
	}
	...
	public function testAutoSizeWithSimpleBackgroundSkinAndNoChildren():Void {
		...
		Assert.equals(SMALL_BACKGROUND_WIDTH, this._container.maxWidth);
		Assert.equals(SMALL_BACKGROUND_HEIGHT, this._container.maxHeight);
	}
	...
	public function testAutoSizeWithComplexBackgroundSkinAndNoChildren():Void {
		...
		Assert.equals(SMALL_BACKGROUND_WIDTH, this._container.width);
		Assert.equals(SMALL_BACKGROUND_HEIGHT, this._container.height);
		Assert.equals(SMALL_BACKGROUND_MIN_WIDTH, this._container.minWidth);
		Assert.equals(SMALL_BACKGROUND_MIN_HEIGHT, this._container.minHeight);
		Assert.equals(Math.POSITIVE_INFINITY, this._container.maxWidth);
		Assert.equals(Math.POSITIVE_INFINITY, this._container.maxHeight);
	}
